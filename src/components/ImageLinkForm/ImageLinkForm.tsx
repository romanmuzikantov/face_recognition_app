        ...
        <div className="flex w-100 justify-center">
            <div className="w-50-l w-100-ns pa4 z-9999 ml3-ns mr3-ns br4 form-card">
                ...
                <div className="flex items-center justify-center" style={{ gap: '0.8rem' }}>
                    <input
                        type="text"
                        className="w-70 f4 pa2 center br4 ba b--near-black"
                        onChange={onInputChange}
                    />
                    <button
                        type="submit"
                        className="w-30 grow f4 link pv2 dib black br4 ph4 bg-washed-green pointer outline-0 ba b--near-black hover-near-white bg-animate hover-bg-near-black"
